...
if __name__ == "__main__":
    ...
    #     fig, ax = plt.subplots()
    #     rects1 = ax.bar(x + widthBar/2, resultDict[type]['CDFArrayOfAll'], widthBar, label='All Strings In The System')
    #     rects2 = ax.bar(x - widthBar/2, resultDict[type]['CDFArrayOfAllGoodAndBadToLastGood'], widthBar, label='All Good And Bad Strings To The Last Good')
    #     # Add some text for labels, title and custom x-axis tick labels, etc.
    #     ax.set_ylabel('Number of strings')
    #     ax.set_title('{0} Error - statistics'.format(type))
    #     ax.set_xticks(x)
