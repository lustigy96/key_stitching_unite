...
def Compute_statistics_for_spesific_error_type(type, numberOfExpiriments, key, fragment_len, fragments_number, window_size, allGoodPossible, rezolution ):
    ...
    for expNum in xrange(0,numberOfExpiriments):
        ...
        percentileArray = Compute_precitle_of_good_samples(allGoodPossible=allGoodPossible,
