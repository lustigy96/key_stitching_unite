    ...
    for codeName in cpuName:
        ...
        for idxK, key_length in enumerate(key_length_vec):
            ...
            for quantile in quantile_vec:
                ...
                try:
                    os.mkdir(DIR_RESULT_PATH + DIR_PATH_REALCHANNEL + CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH)
                except:
                    pass
                tableResult["cpuName_{0}".format(codeName)]["key_length{0}".format(key_length)]["quantile{0}".format(quantile)] = {}

                workbook = xlsxwriter.Workbook(DIR_RESULT_PATH + DIR_PATH_REALCHANNEL + CODE_NAME_PATH + KEY_LENGTH_PATH +
                                               QUANTILE_NUM_PATH + '/simulation_table{0}_Q{1}.xlsx'
                                               .format(key_length_vec[0],  quantile ))
                ...
                for window_size in window_size_vec:
                    ...
                    try:
                        os.mkdir(
                            DIR_RESULT_PATH + DIR_PATH_REALCHANNEL + CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH +
                            WINDOWS_SIZE_PATH)
                    except:
                        pass
                        tableResult["cpuName_{0}".format(codeName)]["key_length{0}".format(key_length)][
                    ...
                    for samples_num in samples_num_vec:
                        ...
                        for probe_len in probe_len_vec:
                            ...
                            try:
                                os.mkdir(
                                    DIR_RESULT_PATH + DIR_PATH_REALCHANNEL + CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH +
                                    WINDOWS_SIZE_PATH + SAMPLE_NUM_PATH + SAMPLE_LEN_PATH)
                            except:
                                pass
                            tableResult["cpuName_{0}".format(codeName)]["key_length{0}".format(key_length)][
                                "quantile{0}".format(quantile)][
                            ...
                            for method in method_vec:
                                ...
                                try:
                                    os.mkdir(DIR_RESULT_PATH + DIR_PATH_REALCHANNEL +
                                             CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH +
                                             WINDOWS_SIZE_PATH + SAMPLE_NUM_PATH + SAMPLE_LEN_PATH +
                                             METHOD_PATH)
                                except:
                                    pass
                                tableResult["cpuName_{0}".format(codeName)][
                                    ...
                                    "window_size{0}".format(window_size)][
                                    "samples_num{0}".format(samples_num)][
                                    "probe_len{0}".format(probe_len)]["{0}".format(method)] = {}
                                ...
                                summryMy = open(DIR_RESULT_PATH + DIR_PATH_REALCHANNEL +
                                             CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH +
                                             WINDOWS_SIZE_PATH + SAMPLE_NUM_PATH + SAMPLE_LEN_PATH +
                                             METHOD_PATH + "/summryMy.txt", "w")

                                if PRINT_RETRIVED_KESYS:
                                    retrievedKeysFile = open(DIR_RESULT_PATH + DIR_PATH_REALCHANNEL +
                                             CODE_NAME_PATH + KEY_LENGTH_PATH + QUANTILE_NUM_PATH +
                                             WINDOWS_SIZE_PATH + SAMPLE_NUM_PATH + SAMPLE_LEN_PATH +
                                ...
                                worksheet.write(r+2, c, str("GOOD") if ok else str ("BAD"))
                                ...
                                tableResult["cpuName_{0}".format(codeName)][
                                    ...
                                    "window_size{0}".format(window_size)][
                                    "samples_num{0}".format(samples_num)][
                                    "probe_len{0}".format(probe_len)]["{0}".format(method)] = dist
