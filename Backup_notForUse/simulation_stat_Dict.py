...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    RESULT_PATH = DIR_RESULT_PATH + "dataForGraph_Key={0}_Graphs={1}_x={2}_windowSize={3}_quantile={4}.txt".format(
    ...
    for key_length in key_length_vec:
        ...
        for megic_num in megic_num_vec:
            f_data = open(RESULT_PATH, "a+")
            summryMy = open(DIR_RESULT_PATH + "summryMy_keyLength={0}_windowSize={1}_quantile={2}_error={3}%.txt".format(key_length,window_size,quantile,int(flip_probability * 100)),"a+")
